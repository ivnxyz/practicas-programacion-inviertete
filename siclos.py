...
#Encuentra cuántas veces aparece la letra 'a' en la siguiente String.
...
lorem_ipsum.count("a")
repeticiones= lorem_ipsum.count("a")
print (repeticiones)

#Separa la siguiente String por comas.
lista_de_compras = "Manzanas,zanahorias,cereal,leche,ramen"
lista_de_compras.split(",")
imprimi= lista_de_compras.split(",")
print(imprimi)


#Impresión en pantalla
#Imprime tu nombre completo con un espacio.
nombre= "Juan Emmanuel"
apellido= "Valencia Toledo"
print(nombre, apellido)
#Imprime la siguientes Strings separadas por comas.
comida= "manzanas, zanahorias, cereal, leche, ramen"
comida.split(",")
imp=comida.split(",")
print(imp)
print(comida)